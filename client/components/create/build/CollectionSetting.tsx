...
import { Button, Col, Form, Image, Input, message, Row, Space, Typography, Upload } from 'antd';
    ...
    <Row justify="center">
      <Col xs={24} lg={16} style={{ padding: '6rem 0px' }}>
        <Row gutter={[32, 32]} align="middle">
          ...
          <Col span={24}>
            <Title level={3}>3. 미공개 NFT 이미지(Reveal NFT)</Title>
          </Col>
          <Col xs={24} lg={14}>
            <Text>
              모두가 궁금해 할 미공개 이미지/동영상을 등록/배포합니다. Reveal NFT 시 NFT 이미지의
              임의성을 유지하기 때문에 공개될 때까지 누가 어떤 NFT 이미지를 갖게 될지 알 수
              없습니다. 미공개 이미지/동영상을 등록하고 블록체인의 컨텍스트에 배포할 수 있는 Mint
              Schedule 설정과 Generative Art Builder에서 메타데이터를 임의의 이미지로 대체할 수 있는
              Reveal 단계로 들어갈 수 있습니다.
            </Text>
          </Col>
          <Col xs={24} lg={10}>
            <Image
